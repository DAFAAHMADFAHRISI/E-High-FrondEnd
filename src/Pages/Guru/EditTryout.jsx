...
const EditTryout = () => {
  const [namaTryout, setNamaTryout] = useState("tryout utbk snbt 2025 ep. 1");
        ...
        >
          ...
          >
            ...
            <motion.input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e4460] focus:border-transparent transition-all"
