      ...
      >
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <motion.textarea
              className="w-full p-3 border border-gray-400 bg-gray-50 rounded-lg h-32 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all"
                ...
                {options.map((option, index) => (
                  ...
                  >
                    <div className="flex-grow relative">
                      <motion.input
                        type="text"
                        className="w-full p-3 border border-gray-400 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent pr-10"
